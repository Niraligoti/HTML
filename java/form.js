function form_validation(){
  ...
  return false;
    ...
    if(mobile ==""){
        document.getElementById("mobile_msg").innerHTML ="enter mobile number"
        return false;
    }else if(isNaN(mobile)){
        document.getElementById("mobile_msg").innerHTML ="enter number only"
        return false;
    }else if(mobile.length < 10){
        document.getElementById("mobile_msg").innerHTML ="mobile number is less than 10 digits"
        return false;
    }
